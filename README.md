...
## Kort beskrivning av verksamhetsfallet
...
<img width="6201" height="2775" alt="LibraryDiagram (1)" src="https://github.com/user-attachments/assets/92b53472-9f8b-4cc4-b5fd-72bb790aea0f" />

ER-diagrammet visar relationerna mellan följande tabeller:
...
## Reflektion kring optimering och dataintegritet

### Dataintegritet
För att säkerställa att datan i systemet är korrekt har flera kontroller lagts till:
...
Custom exceptions används för att hantera fel som till exempel:
- Duplicerade ID:n
...
Execution plans har analyserats för några av de viktigaste frågorna i systemet, till exempel:
- Sökning av böcker
